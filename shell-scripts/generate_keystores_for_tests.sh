...
# under the License.
#
DESTINATION_SERVICE=../chat-deploy-memory/src/main/resources/keystore
DESTINATION_CLIENT=../chat-init/src/main/resources/keystore

mkdir -p $DESTINATION_SERVICE
...
cp client.truststore.jks broker.truststore.jks client.keystore.jks broker.keystore.jks $SCRIPT_DIR/$DESTINATION_SERVICE
