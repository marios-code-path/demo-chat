...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = [ChatUserServiceCassandra::class])
@OverrideAutoConfiguration(enabled = true)
@ImportAutoConfiguration(classes = [ChatUserServiceCassandra::class])
