...
interface TopicMembershipByMemberRepository<T : Any> : ReactiveCassandraRepository<TopicMembershipByMember<T>, T> {
    fun findByMember(id: T): Flux<TopicMembershipByMember<T>>
}

interface TopicMembershipByMemberOfRepository<T : Any> : ReactiveCassandraRepository<TopicMembershipByMemberOf<T>, T> {
